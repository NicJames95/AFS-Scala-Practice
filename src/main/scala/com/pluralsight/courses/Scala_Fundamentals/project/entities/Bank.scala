...
import com.pluralsight.courses.Scala_Fundamentals.services.{AccountService, CustomerService, ProductService, StatisticsService}

import java.time.LocalDate
import java.util.UUID
//class Bank(n: String, c: String, co: String, e: String, ps: Set[Product],
//           cs: Set[Customer], as: Set[Account]) {
//  println(s"$n Established in 2018")
//  val name: String = n
//  val city: String = c
