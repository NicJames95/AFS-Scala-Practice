...
import practice.Doc4_AnimalClassPractice.factorial
...
object HOFs extends App {
  ...
  */
  ...
  Similarly, (A1, A2) => B is the type of functions that take two arguments (of types A1 and A2, respectively) and return a result of type B.

  More generally, (A1, ..., An) => B is the type of functions that take n arguments (of types A1 to An) and return a result of type B.
